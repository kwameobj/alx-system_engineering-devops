This a summary of what my scripts are doing with links to the various scripts.
...
[15-100-lets_move](100-lets_move) : A script that moves all files beginning with an uppercase letter to the directory /tmp/u.
